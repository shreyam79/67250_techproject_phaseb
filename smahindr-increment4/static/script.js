...
//When the submit button is clicked, an alert pops up
document.querySelector('.complete_purchase_input').addEventListener('click', function() {
    alert("Redirecting to payment system.")
})
console.log(document.querySelector('.complete_purchase_input'));